...
export const createIngress = async (ingressType:'WHIP_INPUT' | 'RTMP_INPUT') => {
    ...
    // string type ko waapas IngressInput (livekit-server-sdk) ke enum wale type mei convert kar diya.
    const type = ingressType === "RTMP_INPUT" ? IngressInput.RTMP_INPUT : IngressInput.WHIP_INPUT;
