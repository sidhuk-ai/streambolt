      ...
      <div className="w-full">
        ...
        <div className="relative">
          <Input
            ...
            className={cn("", !isFollowersOnly && "rounded-t-none border-t-0")}
          />
          <Button type="submit" size={"sm"} variant={"ghost"} disabled={isDisabled} className="absolute inset-y-0 end-0 flex items-center justify-center pe-3 peer-disabled:opacity-50">
